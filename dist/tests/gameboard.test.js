...
// Test 1:
test('placeShip() places ship horizontally on the board', function () {
...
// Test 2:
test('placeShip() places ship vertically on the board', function () {
...
test('receiveAttack() registers a hit of a ship by increasing hits', function () {
  testGameboard.placeShip([0, 0], 3, true);
...
test('isOutOfBounds() returns true if out of bounds', function () {
...
test('willOverlap() returns true if ship overlaps', function () {
  testGameboard.placeShip([0, 0], 3, true);
...
// test resetBoard()
test('resetBoard() resets the board', function () {
  testGameboard.placeShip([0, 0], 3, true);
  testGameboard.receiveAttack([0, 0]);
